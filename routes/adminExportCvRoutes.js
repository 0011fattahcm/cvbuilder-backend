...
router.get('/excel/:id', authAdminMiddleware, async (req, res) => {
  const userId = req.params.id;
  const type = req.query.type || 'excel';
  console.log("Admin export CV untuk user ID:", userId);
  const user = await CV.findOne({ user: req.params.id });// ✅ COCOK dengan route
